...
// middleward
app.use(index_1.fileExits, index_1.validateDimensions);
//image route
app.get('/image', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, filename, width, height, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _a = req.query, filename = _a.filename, width = _a.width, height = _a.height;
                _c = (_b = res).sendFile;
                return [4 /*yield*/, (0, utilities_1.getImagePath)(filename, parseInt(height), parseInt(width))];
            case 1:
                _c.apply(_b, [_d.sent()]);
                return [2 /*return*/];
        }
